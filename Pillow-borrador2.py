...
#Funcion que carga una imagen (pero no la muestra.)
def cargar_imagen():
    global imagen
...
root.geometry("450x430")  # Establece el tamaño inicial de la ventana
...
boton_mostrar = tk.Button(root, text="Mostrar Imagen", command=mostrar_imagen, **boton_style1)
